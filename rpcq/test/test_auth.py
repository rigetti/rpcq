...
# Valid, sample Z85-encoded keys generated by pyzmq itself
CLIENT_PUBLIC_KEY = b"YQgx44Ep/{h5s2yKYts]B#RykMn6]0={S<)dSEB7"
CLIENT_SECRET_KEY = b"C{+)JGAqJ9/k^7aFIX*i*B-^VRatb]{DJTRV{&uE"
SERVER_PUBLIC_KEY = b"q]Jir@GVc3+!)8DV/fG.Z6*vv655p-yG1POv#Pny"
SERVER_SECRET_KEY = b"Wv8UXY}j9g%f=-]!}t6pu<3-[!R&oryvRG[0hd7>"
...
def test_client_rpcerrorerror(server, client_auth):
